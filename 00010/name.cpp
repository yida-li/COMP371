...
int main(int argc, char* argv[])
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // cordinate axis from assignment 1
        glBindVertexArray(vao_world);
        ...
        mat4 alphabetOne5 = alphabetOne0
            * translate(mat4(1.0f), vec3(-2.0f, 0.0f, 0.0f))
            * rotate(mat4(1.0f), radians(180.0f), vec3(0.0f, 1.0f, 0.0f));
        ...
        mat4 alphabetTwo0 = groundWorldMatrix
            * scale(mat4(1.0f), vec3(0.01f, 20.0f, 0.01f))
            * translate(mat4(1.0f), cubePosition)
            * scale(mat4(1.0f), vec3(1.0f, 1.0f, 1.0f))
            * rotate(mat4(1.0f), -radians(rotationDeg_horizontal), vec3(0.0f, 1.0f, 0.0f))
        ...
        mat4 alphabetThree0 = groundWorldMatrix
            * scale(mat4(1.0f), vec3(0.01f, 20.0f, 0.01f))
            * translate(mat4(1.0f), cubePosition)
            * scale(mat4(1.0f), vec3(1.0f, 1.0f, 1.0f))
            * rotate(mat4(1.0f), -radians(rotationDeg_horizontal), vec3(0.0f, 1.0f, 0.0f))
        ...
        mat4 alphabetFour0 = groundWorldMatrix
            * scale(mat4(1.0f), vec3(0.01f, 20.0f, 0.01f))
            * translate(mat4(1.0f), cubePosition)
            * scale(mat4(1.0f), vec3(1.0f, 1.0f, 1.0f))
            * rotate(mat4(1.0f), -radians(rotationDeg_horizontal), vec3(0.0f, 1.0f, 0.0f))
        ...
        mat4 alphabetFive0 = groundWorldMatrix
            * scale(mat4(1.0f), vec3(0.01f, 20.0f, 0.01f))
            * translate(mat4(1.0f), cubePosition)
            * scale(mat4(1.0f), vec3(1.0f, 1.0f, 1.0f))
            * rotate(mat4(1.0f), -radians(rotationDeg_horizontal), vec3(0.0f, 1.0f, 0.0f))
        ...
        mat4 Wall2 = groundWorldMatrix
            * scale(mat4(1.0f), vec3(0.01f, 20.0f, 0.01f))
            * translate(mat4(1.0f), vec3(-30.0f, 6.0f, -25.0f))
            //
        ...
        for (GLint yAxis = 0; yAxis < 25; yAxis++) { // row
            for (GLint xAxis = 0; xAxis <= 60; xAxis++) { // column
                ...
                if (xAxis == 8 && (yAxis == 10||  yAxis == 9 || yAxis == 8 || yAxis == 7|| yAxis == 6))continue;
                if (xAxis == 7 && (yAxis == 6 || yAxis == 8))continue;
                if ( xAxis == 6 && (yAxis == 6 ||yAxis == 8 || yAxis == 9 || yAxis == 10 ))continue;
                ...
                */
                ...
                // alphabet 2 : i hole 
                if (xAxis == 18 && (yAxis == 10 || yAxis == 7 || yAxis == 6 || yAxis == 8))continue;


                // alphabet 3 : d hole 

                if (xAxis == 28 && (yAxis == 10 ||yAxis == 9 ||yAxis == 8 ||yAxis == 7 ||yAxis == 6 ))continue;
                if (xAxis == 27 && (yAxis == 6|| yAxis == 8 )) continue;
                if (xAxis == 26 && (yAxis == 8 ||yAxis == 7 ||yAxis == 6 || yAxis == 6))continue;


                // alphabet 4 : a hole 
                if (xAxis == 38 && (yAxis == 8 ||yAxis == 7 ||yAxis == 6))continue;
                if (xAxis == 37 && (yAxis == 6 ||yAxis == 8 ))continue;
                if (xAxis == 36 && (yAxis == 8||yAxis == 7 ||yAxis == 6))continue;
                if (xAxis == 39 && yAxis == 6)continue;

                // alphabet 5 : L hole 
                if (xAxis == 48 && (yAxis == 10 ||yAxis == 9 ||yAxis == 8 ||yAxis == 7 ||yAxis == 6 ))continue;
                if ((xAxis == 49||xAxis == 50) && yAxis == 6)continue;

                mat4 yidaWall = Wall2
                    * scale(mat4(1.0f), vec3(0.2f, 0.2f, 0.1f))
...
int  createVertexArrayObject_Alphabet1() {
    ...
    vec3 vertexArray[] = {  // position,                            color
        vec3(-0.5f,-0.5f,-0.5f), vec3(0.921f,0.203f,0.658f), //left 
        vec3(-0.5f,-0.5f, 0.5f), vec3(0.921f,0.203f,0.658f),
        vec3(-0.5f, 0.5f, 0.5f), vec3(0.921f,0.203f,0.658f),
        vec3(-0.5f,-0.5f,-0.5f), vec3(0.921f,0.203f,0.658f),
        vec3(-0.5f, 0.5f, 0.5f), vec3(0.921f,0.203f,0.658f),
        vec3(-0.5f, 0.5f,-0.5f), vec3(0.921f,0.203f,0.658f),

        vec3(0.5f, 0.5f,-0.5f), vec3(0.921f,0.203f,0.658f), // far 
        vec3(-0.5f,-0.5f,-0.5f), vec3(0.921f,0.203f,0.658f),
        vec3(-0.5f, 0.5f,-0.5f), vec3(0.921f,0.203f,0.658f),
        vec3(0.5f, 0.5f,-0.5f), vec3(0.921f,0.203f,0.658f),
        vec3(0.5f,-0.5f,-0.5f), vec3(0.921f,0.203f,0.658f),
        ...
        vec3(0.5f,-0.5f, 0.5f), vec3(0.921f,0.203f,0.658f), // bottom 
        vec3(-0.5f,-0.5f,-0.5f), vec3(0.921f,0.203f,0.658f),
        vec3(0.5f,-0.5f,-0.5f), vec3(0.921f,0.203f,0.658f),
        vec3(0.5f,-0.5f, 0.5f), vec3(0.921f,0.203f,0.658f),
        vec3(-0.5f,-0.5f, 0.5f), vec3(0.921f,0.203f,0.658f),
        ...
        vec3(-0.5f, 0.5f, 0.5f), vec3(0.921f,0.203f,0.658f), // near 
        vec3(-0.5f,-0.5f, 0.5f), vec3(0.921f,0.203f,0.658f),
        vec3(0.5f,-0.5f, 0.5f), vec3(0.921f,0.203f,0.658f),
        vec3(0.5f, 0.5f, 0.5f), vec3(0.921f,0.203f,0.658f),
        vec3(-0.5f, 0.5f, 0.5f), vec3(0.921f,0.203f,0.658f),
        ...
        vec3(0.5f, 0.5f, 0.5f), vec3(0.921f,0.203f,0.658f), // right 
        vec3(0.5f,-0.5f,-0.5f), vec3(0.921f,0.203f,0.658f),
        vec3(0.5f, 0.5f,-0.5f), vec3(0.921f,0.203f,0.658f),
        vec3(0.5f,-0.5f,-0.5f), vec3(0.921f,0.203f,0.658f),
        vec3(0.5f, 0.5f, 0.5f), vec3(0.921f,0.203f,0.658f),
        ...
        vec3(0.5f, 0.5f, 0.5f), vec3(0.921f,0.203f,0.658f), // top     green 
        vec3(0.5f, 0.5f,-0.5f), vec3(0.921f,0.203f,0.658f),
        vec3(-0.5f, 0.5f,-0.5f), vec3(0.921f,0.203f,0.658f),
        vec3(0.5f, 0.5f, 0.5f), vec3(0.921f,0.203f,0.658f),
        vec3(-0.5f, 0.5f,-0.5f), vec3(0.921f,0.203f,0.658f),

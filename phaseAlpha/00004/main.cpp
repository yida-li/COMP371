...
int main()
{
	...
	GLfloat vertices[] = {
		...
		// cordinate  [open is botomrighttopleft]      RGBA colors                   [stb is toprightbotomleft]
			...
			-0.5f,	0.5f,	0.0f,				0.65f,0.29f,0.29f,					//0.0f,1.0f,                       // lower right corner
			0.5f,	0.5f,	0.0f,				 0.3f,0.65f,0.29f ,					//1.0f,1.0f,							// upper corner
			0.5f,	-0.5f,	0.0f,				 0.51f, 0.29f, 0.65f		//	1.0f,0.0f						// inner left
	...
	*/
	...
	glTexImage2D(GL_TEXTURE_2D, GL_RGBA, widthImg, heightImg, 0, GL_RGBA, GL_UNSIGNED_BYTE, bytes);
	...
	*/
	...
	glClearColor(0.29f, 0.38f, 0.65f, 1.0f);    // 0.65f, 0.19f, 0.36f,   Hex overdrive pink   168, 50, 94
	...
	{
		glClearColor(0.29f, 0.38f, 0.65f, 1.0f);
		glClear(GL_COLOR_BUFFER_BIT);

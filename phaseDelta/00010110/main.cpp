...
int main()
{
    ...
    // --------------------
    GLFWwindow *window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "D22 Enter the cubrix", NULL, NULL);
    if (window == NULL)
    {
    ...
    // ------------------------------------
    Shader lightingShader("cubevertex.shader", "cubefragment.shader");
    Shader lightCubeShader("lightvertex.shader", "lightfragment.shader");
    ...
    glm::vec3 cubePositions[] = {
        ...
        glm::vec3(2.0f, 14.0f, 0.0f),
        glm::vec3(-2.0f, 14.0f, 0.0f),
        glm::vec3(0.0f, 14.0f, 2.0f),
        glm::vec3(0.0f, 14.0f, -2.0f),
        glm::vec3(2.0f, 14.0f, 2.0f),
        glm::vec3(2.0f, 14.0f, -2.0f),
        glm::vec3(-2.0f, 14.0f, 2.0f),
        glm::vec3(-2.0f, 14.0f, -2.0f),

        glm::vec3(0.0f, 16.0f, 0.0f),
        glm::vec3(2.0f, 16.0f, 0.0f),
        glm::vec3(-2.0f, 16.0f, 0.0f),
        glm::vec3(0.0f, 16.0f, 2.0f),
        glm::vec3(0.0f, 16.0f, -2.0f),
